...
def evaluate_port_performance(filename: str = "./results/bloomberg_2yr/GS1_value.csv"):
    ...
    for port_name in prcs.columns:
        ...
        annualized_std = ts.anlzd_stdev(freq=12)  # annualized standard deviation
        annualized_semi_std = ts.semi_stdev(freq=12)  # stdev of downside returns
        ...
        sortino_ratio = ts.sortino_ratio(freq=12)
